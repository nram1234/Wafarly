...
public class FirestTimeSlid extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View view=inflater.inflate(R.layout.slid_layout,container,false);
        ImageView img=view.findViewById(R.id.imageviw);
